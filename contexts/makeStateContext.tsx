...
export function makeStateContext<State>(defaultState: State): IStateContextOutput<State> {
  const initialState: IContextInitialState<State> = [defaultState, () => defaultState]
  const context = createContext<typeof initialState>(initialState)

  const ContextProvider = ({ children, value }: IContextProviderArgs<State>) => {
